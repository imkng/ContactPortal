...
const Header = ({ toggleModal, nbOfContacts }) => {
  ...
  return (
    <div className="relative w-full bg-white mt-3 gap-2">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        <div className="inline-flex items-center space-x-2">
          <span>
            <h3 className="font-bold">Contact List ({nbOfContacts})</h3>
          </span>
        </div>
        ...
        <div className="hidden space-x-2 lg:block">
          ...
          >
            <i className="bi bi-plus-square"></i> Add Contact
          </button>
              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    ...
                    <span className="font-bold">Contect List ({nbOfContacts})</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
